...
int[][][] Seq;
ArrayList<Seq_Container> seq_Container = new ArrayList<Seq_Container>();
int cant_movimientos = -2;

// Contenedores de Font de Processing
PFont f12, f18, f24;

PVector[][][] distancias;
ArrayList<PVector> distancias_sort;
...
void initToolbars() {
  ...
  bar_left.addRadio("BLANCO", 200, true, '!', false, #FFFFFF, 1);
  bar_left.addRadio("NARANJO", 200, true, '@', false, #FF7600, 1);
  bar_left.addRadio("NEGRO", 200, true, '#', false, #000000, 1);
  bar_left.addRadio("GRIS", 200, true, '$', false, #BABABA, 1);
  bar_left.addButton("CARGAR", #009900, 'b', false);
  bar_left.addButton("GUARDAR", #009900, 'b', false);
  bar_left.addSlider("VELOCIDAD", "", 1, 20, 1, 1, '<', '>', false);
  bar_left.addButton("SECUENCIA", #009900, 'b', false);
  bar_left.addButton("RESET", #009900, 'b', false);
  bar_left.addButton("CONECTAR", #009900, 'b', false);
  bar_left.addRadio("ALGORITMO 1", 200, true, '1', false, #FFFFFF, 2);
  bar_left.addRadio("ALGORITMO 2", 200, true, '2', false, #FF7600, 2);
