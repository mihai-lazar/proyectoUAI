void mover(Container container_a_mover, PVector lucar_donde_mover){
  ...
  Containers[int(lucar_donde_mover.x)][int(lucar_donde_mover.y)][int(lucar_donde_mover.z)] = new Container(int(lucar_donde_mover.x), int(lucar_donde_mover.y), int(lucar_donde_mover.z), c.location, container_a_mover.fill, 1);
