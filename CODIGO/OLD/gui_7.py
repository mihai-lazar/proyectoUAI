...
btns_menu.append(Button(window, text='DE SELEC', bg="gray", padx=60, pady=10, command=lambda camion=-1 : set_camion(camion)).place(x=ancho_pantalla-ancho_botones, y=40, width=ancho_botones, height=alto_botones))
btns_menu.append(Button(window, text='SAVE CONFIG', bg="gray", padx=48, pady=10, command=lambda : save_config()).place(x=ancho_pantalla-ancho_botones, y=40, width=ancho_botones, height=alto_botones))
btns_menu.append(Button(window, text='LOAD CONFIG', bg="gray", padx=48, pady=10, command=lambda : load_config()).place(x=ancho_pantalla-ancho_botones, y=40, width=ancho_botones, height=alto_botones))
btns_menu.append(Button(window, text='CLEAR ALL', bg="gray", padx=48, pady=10, command=lambda : clear_all()).grid(row=3, column=10))

for btn_menu in range (0, len(btns_menu)):
    btn_menu
