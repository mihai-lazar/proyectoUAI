      ...
      for(int i = 2; i > container_a_mover.pos_z ; i--){
        if(Containers[container_a_mover.pos_x][container_a_mover.pos_y][i].ocupado){
          for(int e = 0; e < seq_Container.size() ; e++){
             if(seq_Container.get(e).container.pos_x == container_a_mover.pos_x && seq_Container.get(e).container.pos_y == container_a_mover.pos_y && seq_Container.get(e).container.pos_z == i){
               mover(seq_Container.get(e).container, seq_Container.get(e).mover_a);
             }else{
