            ...
            for seq in seqs: 
                ...
                if(btns[int(seq[0][0])][int(seq[0][1])][int(seq[0][2])][0] == 1):
                    ...
                    move_x_y(cabezal[2], cabezal[3],
                             btns[int(seq[0][0])][int(seq[0][1])][int(seq[0][2])][1].winfo_rootx()+pad_x_container, btns[int(seq[0][0])][int(seq[0][1])][int(seq[0][2])][1].winfo_rooty()-pad_y_container-5)
                    ...
                    move_x_y(btns[int(seq[0][0])][int(seq[0][1])][int(seq[0][2])][1].winfo_rootx()+pad_x_container, btns[int(seq[0][0])][int(seq[0][1])][int(seq[0][2])][1].winfo_rooty()-pad_y_container-5,
                             btns[int(seq[1][0])][int(seq[1][1])][int(seq[1][2])][1].winfo_rootx()+pad_x_container, btns[int(seq[1][0])][int(seq[1][1])][int(seq[1][2])][1].winfo_rooty()-pad_y_container-5)
